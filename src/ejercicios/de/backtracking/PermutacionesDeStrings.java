...
public class PermutacionesDeStrings {
    ...
    public static void permuta2(String palabra){
        permuta2("", palabra); // Llamada inicial a la función recursiva con una permutación vacía
    }
    ...
    private static void permuta2(String palabra, String palabra2){
        if(palabra2.length() == 0)
            ...
            for(int i = 0; i < palabra2.length(); i++){
                ...
                permuta2(palabra, palabra2.substring(0,i) + palabra2.substring(i+1)); // Llamada recursiva con la permutación actualizada y la palabra original
